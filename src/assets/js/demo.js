"use strict";
//import Circles from 'plugin/chart/circle/circle.min.js';
import $ from 'jquery'; // Import jQuery
import { Chart, Circles } from 'chart.js'; // Import Chart.js
import jsVectorMap from 'jsvectormap'; // Import jsVectorMap
